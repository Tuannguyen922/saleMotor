...
public class Main {
    public static void main(String[] args) {
        ...
        // MotorbikeModel modelt1 = new MotorbikeModel(1, "Air Blade", "Honda", "Sport", "Xe loai the thao"); 
        // MotorbikeModel modelt2 = new MotorbikeModel(2, "Vision", "Honda", "Pho thong", "Xe loai pho thong");
        // MotorbikeModelDao.getInstance().insert(modelt1);
        // MotorbikeModelDao.getInstance().insert(modelt2);
        ...
        // MotorbikeVersion v1_m1 = new MotorbikeVersion(101 ,"red", "130cc", "35000000", modelt1);
        // MotorbikeVersion v2_m1 = new MotorbikeVersion(102, "white", "130cc", "46000000", modelt1);
        // MotorbikeVersion v1_m2 = new MotorbikeVersion(201, "blue", "170cc", "70000000", modelt2);
        // MotorbikeVersion v2_m2 = new MotorbikeVersion(202, "black", "210cc", "56000000", modelt2);
