...
public class Main {
    public static void main(String[] args) {
        ...
        // constructor: (vin, engine_number, version_id, status)
        ...
        wareHouseService.checkStatus("Vision"); // Kiểm tra trực tiếp bằng tên model
        wareHouseService.checkStatus("Air Blade");
        wareHouseService.checkStatus("SH");
        wareHouseService.checkStatus("Sirius");
        wareHouseService.checkStatus("Exciter"); // Kiểm tra trường hợp xe không có trong kho


        System.out.println("--- 5. THÊM KHÁCH HÀNG ---");
        Customer cus = new Customer("Cristiano Ronaldo", "0909123456", 210, "079012345678", java.time.LocalDate.of(1985, 2, 5), "19 Hoàng Diệu, Ba Đình, Hanoi", "trannv@example.com"); 
        customerService.addNewCustomer(cus); 
        Customer khachHang1 = new Customer("Lionel Messi", "0901234567", 222, "0516653126516", LocalDate.of(1987, 6, 24), "91 Nguyễn Đình Chiểu, Quận 3, Saigon", "dangbao@test.com");
